    ...
    (() => {
        ...
        window.addEventListener("scroll", (() => {
            ...
            document.querySelectorAll("[data-scroll]").forEach(((el, i) => {
                ...
                if (el.offsetTop - document.querySelector(".header").clientHeight <= scrollDistance + 2) {
                    document.querySelectorAll(".header .menu__link").forEach((el => {
                        if (el.classList.contains("active")) el.classList.remove("active");
                    }));
                    document.querySelectorAll(".header .menu__body li")[i].querySelector("a").classList.add("active");
                } else if (el.offsetTop - document.querySelector(".header").clientHeight > scrollDistance) document.querySelectorAll(".header .menu__body li")[i].querySelector("a").classList.remove("active");
            }));
        }));
        window["FLS"] = true;
        isWebp();
