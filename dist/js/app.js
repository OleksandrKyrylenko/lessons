(() => {
    ...
    (() => {
        ...
        window.addEventListener("scroll", (() => {
            ...
            if (scrollDistance >= headerHeight) header.classList.add("header--fixed"); else header.classList.remove("header--fixed");
        }));
        const signInBtn = document.querySelector(".signin-btn");
        const signUpBtn = document.querySelector(".signup-btn");
        const formBox = document.querySelector(".form-box");
        const showPasswordBtn = [ document.getElementById("password__button--1"), document.getElementById("password__button--2"), document.getElementById("password__button--3") ];
        document.body.addEventListener("click", (function(event) {
            if (showPasswordBtn.includes(event.target)) showPassword(event.target);
        }));
        ...
        const showPassword = function(element) {
            ...
            if ("password" === input.getAttribute("type")) input.setAttribute("type", "text"); else input.setAttribute("type", "password");
        };
        window["FLS"] = true;
        isWebp();
        menuInit();
